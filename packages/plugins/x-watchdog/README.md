...
**Plugin repo:** [paperclip_x_watchdog](https://github.com/leeknowsai/paperclip_x_watchdog) | Chạy trên [Paperclip MC](https://github.com/paperclipai/paperclip)

[![Xem video demo](https://img.shields.io/badge/▶_Xem_Video_Demo_(17_phút)-Google_Drive-4285F4?style=for-the-badge&logo=googledrive&logoColor=white)](https://drive.google.com/file/d/1y3VybA3bGnd2GKfTHSprAnLBiQWe-dgq/view?usp=sharing)

<a href="https://drive.google.com/file/d/1y3VybA3bGnd2GKfTHSprAnLBiQWe-dgq/view?usp=sharing">
  <img src="docs/assets/demo-preview.png" alt="X Watchdog Demo Preview" width="720" />
</a>

<details open>
<summary><strong>📋 Mục lục Video Demo</strong></summary>
...
| Thời gian | Nội dung |
|:---------:|----------|
| [`02:16`](https://drive.google.com/file/d/1y3VybA3bGnd2GKfTHSprAnLBiQWe-dgq/view?t=136) | **CEO Agent** — Chi phí, hoạt động, tỉ lệ thành công |
| [`02:30`](https://drive.google.com/file/d/1y3VybA3bGnd2GKfTHSprAnLBiQWe-dgq/view?t=150) | **BD Scorer** — Lead Analyst, pipeline scoring |
| [`04:53`](https://drive.google.com/file/d/1y3VybA3bGnd2GKfTHSprAnLBiQWe-dgq/view?t=293) | **BD Writer** — Outreach Specialist |
| [`04:59`](https://drive.google.com/file/d/1y3VybA3bGnd2GKfTHSprAnLBiQWe-dgq/view?t=299) | **BD Coordinator** — Pipeline Management |

#### ⚙️ Cấu hình & Plugin
| Thời gian | Nội dung |
|:---------:|----------|
| [`06:27`](https://drive.google.com/file/d/1y3VybA3bGnd2GKfTHSprAnLBiQWe-dgq/view?t=387) | **X Watchdog Dashboard** — Leads, Tweets, DMs overview |
...
| [`08:04`](https://drive.google.com/file/d/1y3VybA3bGnd2GKfTHSprAnLBiQWe-dgq/view?t=484) | **Goals** — Mục tiêu công ty |
...
| [`12:45`](https://drive.google.com/file/d/1y3VybA3bGnd2GKfTHSprAnLBiQWe-dgq/view?t=765) | **Insights (beta)** — Analytics & conversion funnel |
